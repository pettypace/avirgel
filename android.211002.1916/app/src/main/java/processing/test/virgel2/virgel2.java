package processing.test.virgel2;
...
public void checkForHelp(){
  ...
  if(mouseX > displayWidth*0.90f && mouseY > displayHeight*0.93f){    
...
public void showTitle(int Y){
  ...
  fill(255,0,0);
  rect(displayWidth*0.91f,displayHeight*0.94f,displayWidth*0.08f,displayHeight*0.05f,25);
  fill(255);
  text("?",displayWidth*0.95f,displayHeight*0.98f);
  fill(0);
}  
