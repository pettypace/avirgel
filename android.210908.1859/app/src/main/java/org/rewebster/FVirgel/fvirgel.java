...
public class fvirgel extends PApplet {




// Finger pointing version as of 05 September 2021
//PImage ptr;
...
//  if(mousePressed) showTheFinger();
  showTheFinger();

}

public void showTheFinger(){
//   strokeWeight(2);
//   fill(0);
...
public void  showPenNotes(int Y){
  ...
  if(displayHeight<displayWidth) fontSize = PApplet.parseInt(displayWidth/50);
  textSize(fontSize);  
  String data = "(FBI recommends 12 - 18 inches)";  
  text(data,displayWidth/2,Y+2*fontSize);   
} 
